        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
            <div class="card card-news">
              ...
              <div class="card-body">
                <h4 class="card-news__title"><a href="#">Adventure companies tipped the scales</a></h4>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
            <div class="card card-news">
              ...
              <div class="card-body">
                <h4 class="card-news__title"><a href="#">Adventureiers resolve to invest in guests</a></h4>
                <ul class="card-news__info">
                  <li><a href="#"><span class="news-icon"><i class="ti-notepad"></i></span> 20th Nov, 2018</a></li>
                  <li><a href="#"><span class="news-icon"><i class="ti-comment"></i></span> 03 Comments</a></li>
                </ul>
